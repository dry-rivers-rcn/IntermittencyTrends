...
metrics <- c("p.pet_cy", "p_mm_cy", "pet_mm_cy", "T_max_c_cy")
...
# facet labels
labs_metrics <- c("p.pet_cy" = "P/PET (CY)", 
                  "p_mm_cy" = "P (CY)", 
                  "pet_mm_cy" = "PET (CY)", 
                  "T_max_c_cy" = "Tmax (CY)")
...
p_region <- 
  ...
  ggsave(file.path("figures_manuscript", "Trends-Climate_Violins-Region.png"),
...
(p_region + p_lat + plot_layout(widths = c(0.6, 0.4))) + 
  ggsave(file.path("figures_manuscript", "Trends-Climate_Violins-Region+Lat.png"),

## RedundancyRandomForest_01_PreliminaryVariableImportance.R
#' This is the same as 01_RandomForest_PreliminaryVariableImportance.R,
#' but drops gages identified as redundant.
#' 
#' Just do national models for now.
...
for (m in metrics){
  ...
  for (r in regions){
    ...
    fit_rf_imp_i %>% 
      readr::write_csv(file = file.path("results", paste0("RandomForestRedundancy_01_PreliminaryVariableImportance_", m, "_", gsub(" ", "", r, fixed = TRUE), ".csv")))
